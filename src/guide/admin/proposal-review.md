...
At first, you will lead to the **outgoing**-proposals section, where you can see a list of all the proposals created by this node. Via the searchbar you can filter after the name.
