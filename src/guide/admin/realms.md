...
Normal administrators can create realms freely after being assigned an initial realm. The developers of
the [FLAME hub interface](https://privateaim.net)
...
4. **Delete** realms by clicking the red trash can button on the right.
...
7. **Activate** another realm than your current one by clicking the blue check button on the right.\
   **Note:** This will change the contents in the "Identity Providers"-, "Clients"-, "Users"-, and "Roles"-tabs in the
   left
